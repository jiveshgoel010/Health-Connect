...
router.get('/signup', (req,res)=>{
    try{
        res.render('signup', {layout: mainLayout, user:req.user});
    } catch(error){
        console.log(error);
    }
})
...
//Middleware to check if user is logged in or not to update login button to logout and viceversa
...
router.get('/home', authMiddleware, (req,res)=>{
    try{
        res.render('home', {layout: mainLayout, user:req.user});
    } catch(error){
        console.log(error);
    }
})
...
router.get('/blogs', authMiddleware, async(req,res)=>{
    try{
        ...
        res.render('blogs', {data:blogposts ,layout : mainLayout, user:req.user});
    } catch(error){
        console.log(error);
    }
});
...
router.get('/add-blogpost', authMiddleware, (req,res)=>{
    try{
        res.render('blogPost/add-blogpost', {layout: mainLayout, user:req.user});
    } catch(error){
        console.log(error);
    }
});
...
router.get('/edit-blogpost/:id', authMiddleware, async(req,res)=>{
    try{
        ...
        res.render('blogPost/edit-blogpost', {data, user:req.user});
    } catch(error){
        console.log(error);
    }
});
